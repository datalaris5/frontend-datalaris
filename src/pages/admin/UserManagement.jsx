...
const UserManagement = () => {
  ...
  const users = [
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'Admin', status: 'Active', stores: 3 },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Manager', status: 'Active', stores: 2 },
    { id: 3, name: 'Bob Wilson', email: 'bob@example.com', role: 'User', status: 'Active', stores: 1 },
  ];
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-900/50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Stores</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-900 dark:text-white">{user.stores}</td>
                  <td className="px-6 py-4">
