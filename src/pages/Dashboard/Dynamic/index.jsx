...
const DynamicDashboard = () => {
  ...
  const onLayoutChange = (layout) => {
    ...
    // In real app, save to User Preferences API here
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <FeatureNotReady message="Fitur Drag n Drop sedang dalam perbaikan">
        {/* Placeholder for now since we need to ensure react-grid-layout works properly */}
      ...
      >
        <div key="a">
          <ChartWidget title="Traffic Overview">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart
                data={data}
                margin={{
        ...
        <div key="b">
          <ChartWidget title="Sales by Category">
             <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} />
                <XAxis dataKey="name" axisLine={false} tickLine={false} />
        ...
        <div key="c">
          <ChartWidget title="Recent Alerts">
            <div className="space-y-4">
               <div className="flex items-start p-3 bg-red-50 dark:bg-red-900/20 rounded-lg text-sm text-red-800 dark:text-red-300">
                  <span className="font-bold mr-2">Stock:</span> Kemeja Flannel (SKU-001) is low on stock (2 left).
               </div>
               <div className="flex items-start p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-sm text-blue-800 dark:text-blue-300">
                  <span className="font-bold mr-2">System:</span> Sync with Shopee completed successfully at 10:00 AM.
               </div>
            </div>
          </ChartWidget>
        </div>
