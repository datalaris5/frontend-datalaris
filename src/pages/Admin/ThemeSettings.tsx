 ...
 * Theme Settings
 * --------------
 * Halaman pengaturan tema untuk admin.
 *
 * Fitur:
 * - Color picker untuk Primary dan Secondary color
 * - Background pattern selection (Plain, Mesh, Dots)
 * - Live preview komponen dengan tema yang dipilih
 * - Reset ke default
 */

import React, { ChangeEvent } from "react";
import { useTheme } from "@/context/ThemeContext";
import { RotateCcw, Palette, Layout } from "lucide-react";
import toast from "react-hot-toast";
import { Button } from "@/components/ui/button";

type BackgroundPattern = "plain" | "mesh" | "dot";
...
const ThemeSettings: React.FC = () => {
  ...
  /**
   * Handler untuk update warna tema
   */
  ...
  /**
   * Handler untuk reset tema ke default
   */
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <Palette className="w-8 h-8 text-primary" /> Theme Settings
          </h1>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="glass-card p-6 rounded-xl shadow-sm">
            <h2 className="text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
              <Layout className="w-5 h-5" /> Color Palette
            </h2>
            <div className="space-y-6">
              {/* Primary Color */}
              <ColorPicker
                label="Primary Color"
                description="Used for main actions, links, and active states."
              ...
              <ColorPicker
                ...
                description="Used for accents, info states, and secondary buttons."
          ...
          <div className="glass-card p-6 rounded-xl shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-3">
              <PatternButton
                pattern="plain"
                label="Plain"
                active={backgroundPattern === "plain"}
                onClick={() => setBackgroundPattern("plain")}
              />
              <PatternButton
                pattern="mesh"
                label="Grid/Mesh"
                active={backgroundPattern === "mesh"}
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                  ...
                  shades (50-950) for perfect contrast.
                </p>
              </div>
            </div>
          </div>
 ...
 * Input warna dengan label dan description
 */
...
/**
 * PatternButton Component
 * Tombol pilihan background pattern
 */
...
const PatternButton: React.FC<PatternButtonProps> = ({
  ...
  >
    <div
      className={`w-full aspect-video rounded bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 ${className}`}
    ></div>
