          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-orange-700 dark:text-orange-400 leading-relaxed">
                ...
                mengupload data. Data akan disimpan berdasarkan toko yang Anda
                pilih.
              </p>
            </div>
          </div>
            ...
            return (
              <button
                ...
                className={`p-3 rounded-xl border-2 text-left transition-all ${
                  isActive
                    ? colors.active
                    : `${colors.inactive} bg-white dark:bg-gray-800`
                }`}
              >
      ...
      <div className="flex-1 min-h-0 flex flex-col gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700 max-h-64 overflow-y-auto">
            {[
              {
                name: "Shopee_Tinjauan_Nov_2024.xlsx",
                date: "29 Nov 2024, 10:30",
                status: "success",
                type: "overview",
              },
              {
                name: "Shopee_Pesanan_Nov_2024.xlsx",
                date: "28 Nov 2024, 14:15",
                status: "success",
                type: "orders",
              },
              {
                name: "Shopee_Iklan_Nov_2024.xlsx",
                date: "27 Nov 2024, 09:45",
                status: "success",
                type: "ads",
              },
            ].map((item, i) => (
