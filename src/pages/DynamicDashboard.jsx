  ...
  if (!widgets || widgets.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Dashboard Belum Dikonfigurasi</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md">
          Admin belum mengatur layout untuk dashboard ini. Silakan hubungi administrator atau login sebagai admin untuk mengatur layout.
        </p>
        <Link to="/admin/builder" className="px-6 py-2 bg-orange-600 text-white rounded-xl font-bold hover:bg-orange-700 transition-colors">
        ...
        return (
          <div className="h-full flex flex-col justify-between bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
            <div className="flex justify-between items-start">
                <div>
                    <h3 className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider font-semibold">{widget.title}</h3>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">Rp 45.2 Jt</p>
                </div>
      ...
      case 'LINE_CHART':
        return (
          <div className="h-full bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col">
            <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-sm">{widget.title}</h3>
  ...
  return (
    <div className="h-full overflow-y-auto overflow-x-hidden">
      <div className="mb-6 flex justify-between items-center">
        <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Dashboard Custom</h1>
            <p className="text-sm text-gray-500">Layout ini disusun oleh Admin menggunakan Page Builder.</p>
        </div>
        <Link to="/admin/builder" className="text-xs text-orange-600 hover:underline">
            Edit Layout (Admin)
        </Link>
      </div>
