...
const StoreManagement = () => {
  ...
  // Mock data
  const stores = [
    { id: 1, name: 'Main Store', platform: 'Shopee', owner: 'John Doe', revenue: 'Rp 125,000,000', status: 'Active' },
    { id: 2, name: 'Fashion Outlet', platform: 'Tokopedia', owner: 'Jane Smith', revenue: 'Rp 89,500,000', status: 'Active' },
    { id: 3, name: 'Electronics Hub', platform: 'TikTok Shop', owner: 'Bob Wilson', revenue: 'Rp 202,000,000', status: 'Active' },
  ];
    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Manage stores and assign users</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {stores.map((store) => (
          <div key={store.id} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{store.platform}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">Owner</span>
                <span className="font-medium text-gray-900 dark:text-white">{store.owner}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">Revenue</span>
                <span className="font-medium text-green-600 dark:text-green-400">{store.revenue}</span>
              </div>
            </div>
