 ...
 * --------------------
 * Halaman checkout pembayaran untuk upgrade ke Pro Plan.
 *
 * Metode Pembayaran:
 * - QRIS (GoPay, OVO, Dana)
 ...
 *
 * Catatan: Sistem pembayaran masih dalam maintenance
 */
...
const SubscriptionPayment: React.FC = () => {
  ...
  /**
   * Handler untuk proses pembayaran (simulasi)
   */
...
const PaymentMethodButton: React.FC<PaymentMethodButtonProps> = ({
  ...
  >
    ...
    {active && <CheckCircle className="h-5 w-5 text-orange-600" />}
  </button>
);
