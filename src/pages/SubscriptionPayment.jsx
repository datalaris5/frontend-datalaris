...
import { CreditCard, Smartphone, QrCode, CheckCircle, ShieldCheck, ArrowLeft, Loader2 } from 'lucide-react';
...
const SubscriptionPayment = () => {
  ...
  const plan = location.state?.plan || { name: 'Pro', price: 'Rp 99.000', period: '/bulan' };
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4 transition-colors">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 max-w-md w-full text-center space-y-6 animate-fade-in-up">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">Terima kasih telah berlangganan paket {plan.name}. Akun Anda telah diupgrade.</p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700">
            <div className="flex justify-between text-sm mb-2">
              <span className="text-gray-500 dark:text-gray-400">Jumlah dibayar</span>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="p-6 space-y-4">
                <div 
                  ...
                  className={`flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === 'card' ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600'
                  }`}
                >
                  <div className={`p-3 rounded-full mr-4 ${paymentMethod === 'card' ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}>
                    <CreditCard size={24} />
                  </div>
                  <div className="flex-1">
                    <p className="font-bold text-gray-900 dark:text-white">Kartu Kredit / Debit</p>
                ...
                <div 
                  ...
                  className={`flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === 'qris' ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600'
                  }`}
                >
                  <div className={`p-3 rounded-full mr-4 ${paymentMethod === 'qris' ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}>
                    <QrCode size={24} />
                  </div>
                  <div className="flex-1">
                    <p className="font-bold text-gray-900 dark:text-white">QRIS</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">GoPay, OVO, Dana, ShopeePay</p>
                  </div>
                </div>
                ...
                <div 
                  ...
                  className={`flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === 'ewallet' ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600'
                  }`}
                >
                  <div className={`p-3 rounded-full mr-4 ${paymentMethod === 'ewallet' ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}>
                    <Smartphone size={24} />
                  </div>
                  <div className="flex-1">
                    <p className="font-bold text-gray-900 dark:text-white">E-Wallet</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">LinkAja, AstraPay</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {paymentMethod === 'card' && (
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 animate-fade-in">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Detail Kartu</h3>
                <form onSubmit={handlePayment} className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nomor Kartu</label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Masa Berlaku</label>
                      <input 
                        type="text" 
                        placeholder="MM/YY" 
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sticky top-8">
              ...
              <div className="flex justify-between items-start mb-4 pb-4 border-b border-gray-100 dark:border-gray-700">
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white">Paket {plan.name}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Langganan Bulanan</p>
                </div>
                <span className="font-bold text-gray-900 dark:text-white">{plan.price}</span>
              </div>
